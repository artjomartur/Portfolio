...
const TECH_LOGOS = [
  ...
  { name: 'Framer Motion', src: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/framer/framer-original.svg' },
  { name: 'LaTeX', src: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/latex/latex-original.svg' },
  { name: 'AppleScript', src: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/apple/apple-original.svg' },
        ...
        <div className="tech-marquee-track">
          ...
          {[...TECH_LOGOS, ...TECH_LOGOS, ...TECH_LOGOS].map((logo, index) => (
            <div key={`${logo.name}-${index}`} className="tech-marquee-item">
              <img src={logo.src} alt={logo.name} className="tech-marquee-icon" loading="lazy" />
