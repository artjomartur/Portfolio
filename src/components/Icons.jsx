...
export function LetterboxdIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      <path d="M4.887 18.067C1.597 18.067 0 15.688 0 12.001c0-3.688 1.597-6.068 4.887-6.068 3.29 0 4.887 2.38 4.887 6.068 0 3.687-1.597 6.066-4.887 6.066Zm14.226 0c-3.29 0-4.887-2.38-4.887-6.066 0-3.688 1.597-6.068 4.887-6.068 3.29 0 4.887 2.38 4.887 6.068 0 3.687-1.597 6.066-4.887 6.066Zm-7.113-5.26c-2.302 0-3.418-1.666-3.418-4.249 0-2.584 1.116-4.25 3.418-4.25 2.302 0 3.418 1.666 3.418 4.25 0 2.583-1.116 4.249-3.418 4.249Z" />
    </svg>
  );
}
